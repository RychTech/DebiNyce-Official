  ...
  return (
    <div className="auth-page">
      ...
      <div className="auth-layout">
        ...
        <div className="auth-visual">
          <div style={{ textAlign: 'center' }}>
            ...
            >
              Join a music platform built for listeners and artists alike —
              with synced lyrics, stunning visuals, and a community that
              treats musicians right.
            </div>
          </div>
        </div>
        ...
        <div className="auth-content">
          ...
          <p className="auth-subtitle">Free signup — no approval needed</p>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            <div className="form-group">
              <label className="label" htmlFor="signup-name">Full name (optional)</label>
              <input
                id="signup-name"
                className="input"
                type="text"
          ...
          <div style={{ marginTop: '24px' }}>
            ...
            <span style={{ color: 'var(--black-400)', fontSize: '0.8125rem', textAlign: 'center', marginBottom: '12px', display: 'block' }}>
              Or sign up with
            </span>
      ...
      <div className="auth-footer">
        ...
        {' · '}
        <a href="/artistsignup">Want to be an artist?</a>
      </div>
    </div>
  )
}
